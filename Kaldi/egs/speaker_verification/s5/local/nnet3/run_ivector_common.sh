...
if [ $stage -le 2 ]; then
  ...
  steps/align_fmllr.sh --nj 30 --cmd "$train_cmd" \
    data/train_sp data/lang $gmm_dir $ali_dir || exit 1
fi
...
echo "55555555555555555555555555555555555555555555"
if [ $stage -le 5 ]; then
...
echo "66666666666666666666666666666666666666666666666666666666666"
if [ $stage -le 6 ]; then
...
echo "77777777777777777777777777777777_1"
if [ $stage -le 7 ]; then
...
echo "888888888888888888888888888888888888_1"
if [ $stage -le 8 ]; then
  for dataset in test train; do
    steps/online/nnet2/extract_ivectors_online.sh --cmd "$train_cmd" --nj 30 \

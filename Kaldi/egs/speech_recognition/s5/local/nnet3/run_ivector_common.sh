...
if [ $stage -le 5 ]; then
  steps/online/nnet2/train_diag_ubm.sh --cmd "$train_cmd" --nj 1 --num-frames 200000 \
...
echo "#####common 7777777777777777777777777######"
if [ $stage -le 7 ]; then
...
echo "#######common 8888888888888888888888888888888888#####"
if [ $stage -le 8 ]; then
  for dataset in test train; do
    steps/online/nnet2/extract_ivectors_online.sh --cmd "$train_cmd" --nj 1 \
